...
Upload three files to your repo root via **Upload Files** (never the mobile editor):
- The SVG uploaded once as `icon-192.svg`
- The same SVG uploaded again as `icon-512.svg`
- `manifest.json`

No conversion. No renaming before upload. Just upload the SVG twice with different filenames.
